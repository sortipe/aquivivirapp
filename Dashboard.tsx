...
const CalculatorCard = () => {
    ...
    return (_jsxs("div", { className: "bg-white p-6 rounded-lg shadow", children: [_jsx("h3", { className: "text-sm font-medium text-slate-500 border-b border-slate-200 pb-3 mb-4", children: "Calculadora de Impuestos" }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "amount", className: "sr-only", children: "Monto" }), _jsxs("div", { className: "relative rounded-md shadow-sm", children: [_jsx("div", { className: "absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none", children: _jsx("span", { className: "text-slate-500 text-lg", children: currency === 'USD' ? '$' : 'S/' }) }), _jsx("input", { type: "text", name: "amount", id: "amount", className: "focus:ring-orange-500 focus:border-orange-500 block w-full pl-10 pr-20 py-2 text-lg bg-white text-slate-900 border-slate-300 rounded-md", placeholder: "0.00", value: amount, onChange: handleAmountChange, inputMode: "decimal", "aria-label": "Monto a calcular" }), _jsx("div", { className: "absolute inset-y-0 right-0 flex items-center", children: [_jsx("label", { htmlFor: "currency", className: "sr-only", children: "Moneda" }), _jsxs("select", { id: "currency", name: "currency", className: "focus:ring-orange-500 focus:border-orange-500 h-full py-0 pl-2 pr-7 border-transparent bg-transparent text-slate-500 text-base rounded-md", value: currency, onChange: (e) => setCurrency(e.target.value), children: [_jsx("option", { children: "USD" }), _jsx("option", { children: "PEN" })] })] })] })] }), _jsxs("div", { className: "space-y-2 pt-2", children: [_jsxs("div", { className: "flex justify-between items-center bg-slate-50 p-2 rounded-md", children: [_jsx("p", { className: "text-sm font-medium text-slate-700", children: "Alcabala (3%)" }), _jsx("p", { className: "text-sm font-semibold text-slate-800", children: formatCurrency(alcabala) })] }), _jsxs("div", { className: "flex justify-between items-center bg-slate-50 p-2 rounded-md", children: [_jsx("p", { className: "text-sm font-medium text-slate-700", children: "Renta (5%)" }), _jsx("p", { className: "text-sm font-semibold text-slate-800", children: formatCurrency(renta) })] })] }), _jsx("div", { className: "flex justify-end pt-1", children: _jsx("button", { onClick: () => setAmount(''), className: "text-xs text-orange-600 hover:underline focus:outline-none", children: "Limpiar" }) })] })] }));
};
...
const Dashboard = ({ currentUser, properties, visits, users, tasks, dailyLogs, onAddDailyLog, onGoToTaskProperty, onSelectVisit, onOpenAddVisitModal, onCompleteTask, onOpenVisitEditor }) => {
    ...
    const myTasks = tasks.filter(t => t.workerId === currentUser.id);
